...
const Users = require("../api/users/userModel.js");
const { isValid } = require("../api/users/userValid.js");
const constants = require("./secret.js");
...
router.post("/login", (req, res) => {
  ...
  if (isValid(req.body)) {
    Users.filterUserBy({ username: username })
      .then(([user]) => {
